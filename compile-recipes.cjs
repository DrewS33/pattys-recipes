...
const outputFiles = [
  'batch1', // chicken pt1
  'batch2', // chicken pt2
  'batch3', // chicken soups/special
  'batch4', // beef/pork pt1
  'batch5', // beef/pork pt2
  'batch6', // seafood/pasta
  'batch7', // desserts/sides
];

const baseDir = 'S:\\Claude\\Moms Recipe App\\pattys-recipes\\recipe-batches';
...
for (const fileId of outputFiles) {
  const filePath = path.join(baseDir, `${fileId}.json`);
  try {
